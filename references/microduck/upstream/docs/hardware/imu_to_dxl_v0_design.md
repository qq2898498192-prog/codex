...
This reference copy omits the upstream private-project identifiers, order metadata and historical quotations. See the public upstream repository for the original revision. Hardware validation remains incomplete.
